  ...
  <tbody>
  	<?php foreach ($fabricante as $fabricante_item): ?>
  		<tr>
  			...
  			<td><a href="<?php echo $fabricante_item['url_excluir']; ?>"  class="btn btn-secondary deletar_fabricante" data-toggle="modal" data-target="#exampleModalCenter">Excluir</a></td>
  		</tr>

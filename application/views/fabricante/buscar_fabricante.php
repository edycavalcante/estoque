<div  id="buscarbase">
 ...
 <!-- search box container starts  -->
  ...
  <!-- search box container ends  -->
     ...
     <div id="txtHint" style="padding-top:50px; padding-bottom:20px;  text-align:center;" ><b>Informações do fabricante...</b></div>
...
$(document).ready(function(){
   $("#buscar").keyup(function(){
       ...
       console.log(str);
       if(str == "") {
               $( "#txtHint" ).html("<b>Informações do fabricante</b>"); 
       }else {

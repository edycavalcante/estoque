...
--
-- Host: 127.0.0.1
-- Generation Time: 18-Jul-2018 às 19:54
...
INSERT INTO `baixa_estoque` (`id_baixa`, `quantidade`, `data_baixa`, `fk_equipamento_id`, `fk_setor_id`, `descricao`) VALUES
(1, 1, NULL, 5, NULL, 'teste baixa'),
(2, 1, '2018-07-12', 5, 1, 'teste baixa 2'),
(3, 1, '2018-07-12', 5, 5, 'teste baixa 3'),
(4, 1, '2018-07-12', 5, 5, 'teste baixa 3'),
(5, 2, '2018-07-12', 11, 7, '2 mouses para ser utilizado na coordenção de mecânica.'),
(6, 5, '2018-07-11', 11, 2, 'baixe de 5'),
(7, 2, '2018-07-06', 11, 2, 'baixa 2, vai para 8'),
(8, 1, '2018-07-10', 11, 4, 'baixa de 1 ');
...
--
ALTER TABLE `baixa_estoque`
  MODIFY `id_baixa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `equipamento`
  MODIFY `id_equipamento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
ALTER TABLE `baixa_estoque`
  ...
  ADD CONSTRAINT `FK_Baixa_ID_Local` FOREIGN KEY (`fk_local_id`) REFERENCES `local` (`id_local`);
